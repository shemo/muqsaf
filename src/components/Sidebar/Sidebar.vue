<template>
  <div
    :class="!userSelected ? 'py-4' : 'pt-4 md:py-4'"
    class="relative md:left-0 md:w-80 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-primary flex flex-wrap items-center justify-center h-full z-50"
  >
...
"
    ...
    <div v-else class="flex flex-col justify-between mx-5">
      <div class="bg-primary-lightest rounded-lg mt-5">
        ...
        <div class="p-2">
          <h4 class="text-gray-400 text-sm mb-5">{{ order.length }} منتجات</h4>
          <div
